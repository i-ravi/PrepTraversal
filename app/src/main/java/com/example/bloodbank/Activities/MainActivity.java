...
public class MainActivity extends AppCompatActivity {
    ...
    TextView make_request_button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        make_request_button=findViewById(R.id.make_request_button);
        linearLayoutEt=findViewById(R.id.linearLayout);
        linearLayoutEt.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void populateHomePage(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Endpoints.any_request, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                System.out.println(requestDataModels);
